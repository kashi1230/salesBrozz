            ...
            child: Card(
              ...
              child: DataTable(
                columns: [
                  ...
                  DataColumn(label: TextBuilder(text:'Email',fontSize: 16,fontWeight: FontWeight.bold,)),
                   DataColumn(label: TextBuilder(text:'City',fontSize: 16,fontWeight: FontWeight.bold,)),
                  DataColumn(label: TextBuilder(text:'State',fontSize: 16,fontWeight: FontWeight.bold,)),
                  DataColumn(label: TextBuilder(text:'PinCode',fontSize: 16,fontWeight: FontWeight.bold,)),
                  DataColumn(label: TextBuilder(text:'Permissions',fontSize: 16,fontWeight: FontWeight.bold,)),
                ],
